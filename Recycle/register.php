...
<body>
  ...
  <div id="login">
    <form id="login_form" method="POST" action="register_blog.php" enctype="multipart/form-data">
      ...
      <div class="field_container">
        <input type="text" name="barcode" placeholder="Laptop Barcode">
      </div>
      <div class="field_container">
      ...
      <div class="field_container">
        <label for="student_photo" class="photo_label">Student Photo</label>
